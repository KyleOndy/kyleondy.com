...
The common module holds untiles we use accross other modules

\begin{code}
import Common (postsPattern, notesPattern, staticPattern, pagesPattern, customPandocCompiler, cleanRoute)
\end{code}
...
simpleRules = do
  templates
  -- static -- todo:remove this comment. just to have less verbose build
  pages
\end{code}
